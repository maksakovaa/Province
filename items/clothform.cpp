...
void ClothForm::setStyleWearBtn(int size, int hips, int condition, int group)
{
    ...
    QIcon icon = QIcon("data/img/clothing/icons/" + intQStr(iconNum) + ".png");
...
void ClothForm::setStyleTrahRemoveBtn(int group)
{
    if(group < ClothGroup::sportsSuit)
    {
        ui->pushBtnTrash->setIcon(QIcon("data/img/clothing/icons/8.svg"));
        ui->pushBtnTrash->setToolTip("Вы не можете отправить эту вещь в корзину.");
        ui->pushBtnRemove->setIcon(QIcon("data/img/clothing/icons/10.svg"));
    ...
    {
        ui->pushBtnTrash->setIcon(QIcon("data/img/clothing/icons/7.svg"));
        ui->pushBtnTrash->setToolTip("В корзину.");
        ui->pushBtnRemove->setIcon(QIcon("data/img/clothing/icons/9.svg"));

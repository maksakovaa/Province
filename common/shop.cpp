...
void Shop::actionHandler(const QString link)
{
    current = link;
    makeShop();
...
{
    QString str[17];
    str[0] = "В холле стоит <a href='zz_atm'>универсальный банковский терминал</a>, где вы можете положить или снять деньги со счета, пополнить баланс мобильного, а также оплатить некоторые услуги.<br>Самое большое место в супермаркете занимает <a href='shop_food'>продуктовый отдел</a>, но в магазине есть еще отделы <a href='shop_cosmetics'>косметики</a>, <a href='shop_common'>хозяйственный</a>, <a href='shop_clothing'>одежды</a>, и отдел <a href='shop_tech'>бытовой техники</a>.";
    str[1] = "Чуть в сторонке разместился небольшой <a href='shop_sport'>магазинчик спорттоваров.</a>";
    str[2] = "Недалеко от входа стоит <a href='zz_common_icecream'>прилавок с мороженным</a> и <a href='zz_common_coffee'>кофейня.</a>";
    str[3] = "Ваша сестра <a href='sister'>Аня</a> сидит на кассе.";
    str[4] = "В магазине толпы покупателей";
    str[5] = "Расставлять продукцию";
    str[6] = "Вы расставляли продукцию довольно долгое время и когда наконец справились, то пошли на кассу, где вам пробили чек.";
    str[7] = "Выйти";
    str[8] = "Магазин закрыт.";
    str[9] = "Выйти из магазина";
    str[10] = "Выйти из отдела";
    str[11] = "<green>Вы купили </green>";
    str[12] = "<red>Вы столько не унесете!</red>";
    str[13] = "- Извините, мы закрыты. Работаем с 8 до 21 часов.";
    str[14] = "<red>Купить</red>";
    str[15] = "Недостаточно средств";
    str[16] = "<red>У вас уже есть</red>";
    return str[id];
}
...
{
    QString path = "data/img/clothing/";

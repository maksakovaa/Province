    ...
    , ui(new Ui::MenuDial)
{
    ...
    videoWidg->setQUrl("data/img/start/" + QString::number(getRandInt(4,5)) + ".webm", 900,600);
...
void MenuDial::fillLegend()
{
    ...
    persons += "<tr>";
    persons += "<td><p><img src=\"data/img/start/nerd.jpg\"/></p><p><a href=\"nerd\"><span style=\" font-size:14pt; font-weight:700; color:#000000;\">" + getStr(0) + "</span></a><br/>" + getStr(1) + "</p></td>";
    persons += "<td><p><img src=\"data/img/start/schoolgirl.jpg\"/></p><p><a href=\"schoolgirl\"><span style=\" font-size:14pt; font-weight:700; text-decoration: underline; color:#000000;\">" + getStr(2) + "</span></a><br/>" + getStr(3) + "</p></td>";
    persons += "<td><p><img src=\"data/img/start/dancer.jpg\"/></p><p><a href=\"dancer\"><span style=\" font-size:14pt; font-weight:700; text-decoration: underline; color:#000000;\">" + getStr(4) + "</span></a><br/>" + getStr(5) + "</p></td>";
    persons += "</tr>";
    persons += "<tr>";
    persons += "<td><p><img src=\"data/img/start/sportgirl.jpg\"/></p><p><a href=\"sportgirl\"><span style=\" font-size:14pt; font-weight:700; text-decoration: underline; color:#000000;\">" + getStr(6) + "</span></a><br/>" + getStr(7) + "</p></td>";
    persons += "<td><p><img src=\"data/img/start/playgirl.jpg\"/></p><p><a href=\"playgirl\"><span style=\" font-size:14pt; font-weight:700; text-decoration: underline; color:#000000;\">" + getStr(8) + "</span></a><br/>" + getStr(9) + "</p></td>";
    persons += "<td><p><img src=\"data/img/start/frivolous.jpg\"/></p><p><a href=\"frivolous\"><span style=\" font-size:14pt; font-weight:700; text-decoration: underline; color:#000000;\">" + getStr(10) + "</span></a><br/>" + getStr(11) + "</p></td>";
    persons += "</tr>";
    persons += "</table>";
    ...
    QString txt = "<img src='data/img/start/start1.jpg'></img><br>";
    ...
    QString txt2 = "<img src='data/img/start/start3.jpg'></img><br>";
    ...
    QString txt3 = "<img src='data/img/start/start2.jpg'></img><br>";
...
void MenuDial::on_labelPersons_linkActivated(const QString &link)
{
    ...
    ui->label_image->setPixmap(QPixmap("data/img/start/" + link + "_big.jpg"));
